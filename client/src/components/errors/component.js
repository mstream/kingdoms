...
export const Component = ({ errors }: Props) => {
    ...
    return (
        <div data-testid={testId}
            ...
            />
            <div
                className="metal-black-bg absolute w-9/12 min-h-3/4 rounded-sm shadow-lg flex flex-col items-center justify-center overflow-hidden bg-gray-800"
            >
                <p>Error</p>
                <ul className="w-3/4 break-words">
                    {errorsComponents}
                </ul>
            </div>
        </div>
