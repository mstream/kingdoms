...
describe('ErrorsComponent', () => {
    test('is hidden when there are no errors', async () => {
    ...
    test('displays errors', async () => {
        ...
        await expect(queryByText('error message 1')).toBeInTheDocument();
        await expect(queryByText('error message 2')).toBeInTheDocument();
    });
});
