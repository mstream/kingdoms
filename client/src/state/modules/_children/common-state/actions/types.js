...
export type ClientUpdateStateAction = BaseAction<
    typeof UPDATE_STATE,
    $ReadOnly<{ commonState: CommonState }>,
>;
export type ClientRequestBuildingUpgradeAction = BaseAction<
    typeof REQUEST_BUILDING_UPGRADE,
    $ReadOnly<{ cityId: string, buildingType: CommonStateBuildingKey }>,
>;
export type ClientRequestCityCreationAction = BaseAction<
    typeof REQUEST_CITY_CREATION,
    $ReadOnly<{ name: string }>,
>;
export type ClientRequestCityNameChangeAction = BaseAction<
    typeof REQUEST_CITY_NAME_CHANGE,
    $ReadOnly<{ cityId: string, name: string }>,
>;

export type ClientRequestOrderCreationAction = BaseAction<
