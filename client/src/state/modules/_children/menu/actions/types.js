...
export const SELECT_CITY_VIEW_ORDERS_TAB: 'SELECT_CITY_VIEW_ORDERS_TAB' = 'SELECT_CITY_VIEW_ORDERS_TAB';
...
export const UPDATE_ATTACK_VIEW_MINIMUM_DELAY: 'UPDATE_ATTACK_VIEW_MINIMUM_DELAY' = 'UPDATE_ATTACK_VIEW_MINIMUM_DELAY';
...
export type ClientSelectCityViewOrdersTabAction = BaseAction<typeof SELECT_CITY_VIEW_ORDERS_TAB, $ReadOnly<{ orderId: string, }>>;
...
export type ClientUpdateAttackViewMinimumDelayAction = BaseAction<typeof UPDATE_ATTACK_VIEW_MINIMUM_DELAY, $ReadOnly<{ minimumDelay: number, }>>;
