...
export type CommonAbandonCityAction = BasePlayerAction<
    typeof ABANDON_CITY,
    $ReadOnly<{ cityId: string, playerId: string }>,
>;
export type CommonChangeCityNameAction = BasePlayerAction<
    typeof CHANGE_CITY_NAME,
    $ReadOnly<{ cityId: string, name: string, playerId: string }>,
>;
export type CommonCreateCityAction = BasePlayerAction<
    typeof CREATE_CITY,
    $ReadOnly<{ cityId: string, name: string, playerId: string }>,
>;
export type CommonUpgradeBuildingAction = BasePlayerAction<
