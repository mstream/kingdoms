...
export const validateCommonStateType: TypeValidator< CommonState > = (
    ...
    return CommonStateType.assert(
        toValidate,
    );

};

export const validateUnitType: TypeValidator< CommonStateUnitKey > = (
    {
        toValidate,
    },
) => {

    return CommonStateUnitKeyType.assert(
        toValidate,
    );

};

export const validateServerResponseType: TypeValidator< ServerResponse > = (
    {
        toValidate,
    },
) => {

    return ServerResponseType.assert(
        toValidate,
    );
